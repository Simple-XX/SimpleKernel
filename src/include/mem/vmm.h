...
static const uint64_t VMM_PAGE_TABLE_SIZE =
    VMM_PAGES_PRE_PAGE_TABLE * VMM_PAGE_SIZE;
...
static const uint64_t VMM_PAGES_TOTAL = VMM_VMEM_SIZE / VMM_PAGE_SIZE;
...
// 映射内核需要的页数
static const uint32_t VMM_PAGES_KERNEL = VMM_KERNEL_SIZE / VMM_PAGE_SIZE;
