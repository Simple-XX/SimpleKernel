...
namespace COMMON {
    ...
    // 物理内存大小 2GB
    // TODO: 由引导程序传递
    static constexpr const size_t PMM_SIZE = 2 * GB;
    // 内核空间占用大小，包括内核代码部分与预留的
    // 64MB
    static constexpr const size_t KERNEL_SPACE_SIZE = 64 * MB;
    // 页大小 4KB
    ...
    // 物理内存大小 128MB
    // TODO: 由引导程序传递
    static constexpr const size_t PMM_SIZE = 128 * MB;
    // 内核空间占用大小，包括内核代码部分与预留的
    // 8MB
    static constexpr const size_t KERNEL_SPACE_SIZE = 8 * MB;
    // 页大小 4KB
    static constexpr const size_t PAGE_SIZE = 4 * KB;
#endif
