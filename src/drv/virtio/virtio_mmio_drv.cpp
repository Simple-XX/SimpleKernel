...
virtio_mmio_drv_t::virtio_mmio_drv_t(const resource_t& _resource)
    ...
    // 设置队列
    queues.push_back(new packed_virtqueue_t(8));
    add_to_device(0);
...
//        // mark page writeable
//        mode = packed_virtqueue_t::virtq_desc_t::VIRTQ_DESC_F_WRITE;
//    }
//
