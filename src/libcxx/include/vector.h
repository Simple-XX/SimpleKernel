...
#undef min
    ...
    private:
        ...
        iterator fill_insert(iterator pos, size_type n,
                             const value_type &value);
        template <class IIter>
    ...
    vector<T> &vector<T>::operator=(const vector &rhs) {
        if (this != &rhs) {
            ...
            if (len > capacity()) {
                ...
                mystl::uninitialized_copy(rhs.begin() + size(), rhs.end(),
                                          end_);
    ...
    void vector<T>::range_init(Iter first, Iter last) {
        const size_type init_size = mystl::max(
            static_cast<size_type>(last - first), static_cast<size_type>(16));
    ...
    vector<T>::fill_insert(iterator pos, size_type n, const value_type &value) {
        ...
        if (static_cast<size_type>(cap_ - end_) >=
            ...
            if (after_elems > n) {
                ...
                end_ = mystl::uninitialized_fill_n(end_, n - after_elems,
                                                   value_copy);
