...
#ifndef SIMPLEKERNEL_SRC_KERNEL_DRIVER_OPENSBI_INCLUDE_OPENSBI_H
#define SIMPLEKERNEL_SRC_KERNEL_DRIVER_OPENSBI_INCLUDE_OPENSBI_H
...
#endif  // SIMPLEKERNEL_SRC_KERNEL_DRIVER_OPENSBI_INCLUDE_OPENSBI_H
