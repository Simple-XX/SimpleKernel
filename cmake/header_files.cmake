...
function(target_include_drv_header_files Target)
    ...
    target_include_directories(${Target} PRIVATE ${SimpleKernel_SOURCE_CODE_DIR}/drv/mouse/include)
endfunction()
...
function(target_include_common_header_files Target)
    ...
    target_include_directories(${Target} PRIVATE ${SimpleKernel_SOURCE_CODE_DIR}/include/sched)
    target_include_directories(${Target} PRIVATE ${SimpleKernel_SOURCE_CODE_DIR}/include/task)
endfunction()
